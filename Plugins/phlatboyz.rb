...
module PhlatScript
   ...
   if (Sketchup.version.split('.')[0].to_i < 13)
      ...
      if (myc == nil)  #file does not exist
         ...
         correctversion = "1.06"  #this must match the version string in the file!
   ...
   class PhlatScriptExtention < SketchupExtension 
     def initialize
       ...
       self.version = '1.5b'   #after 80c0152c599a717cf5aedd9580e9de0dae2b580c
       ...
       self.copyright = '2017..2021, Phlatboyz' 
     end
